...
public class PlayerHealth : NetworkBehaviour
{
    ...
    PlayerAttack playerShooting;                              // Reference to the PlayerShooting script.                                             // Whether the player is dead.
    ...
    IEnumerator HealPower()
    {
        if (TimerHealPower >= 25f)
        {
            ...
            HeartAfterHEal.GetComponent<Image>().enabled = true;
